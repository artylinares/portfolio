import{ih as $e,c0 as x,ck as k,cz as Fe,jg as et,bR as Bt,dL as Ht,ie as Wt,g7 as V,i4 as kt,p5 as Ut,jz as Yt,wj as tt,a6 as c,a7 as H,af as at,wk as Zt,wl as qt,jb as Q,cs as ot,ja as Oe,ic as je,i2 as Xt,lB as Jt,wm as U,_ as he,gt as rt,jy as ne,bF as re,fi as Kt,fk as Qt,dF as ea,aM as ta,iX as aa,f3 as oa,c5 as z,fX as ra,hs as ia,cD as na,c9 as sa,cb as la,c_ as we,fu as ca,fy as Ge,c6 as da,i0 as ua}from"./index-BJOYTI8a.js";import{ab as P,i as me,d as pe,aX as I,a as it,aY as fe,aZ as nt,a_ as st,a$ as ha,b0 as W,b1 as ma,b2 as pa,ad as fa,f as va,b3 as J,r as N,a2 as ae,D as A,E as D,b4 as j,G as K,b as y,I as G,al as ga,H as xa,b5 as ba,b6 as lt,q as se,aj as ct,o as dt,aU as ut,g as wa,j as Ne,k as ve,s as ht,b7 as ya,aH as Ma,u as Ta,v as Be,ah as _a,aa as _,aF as Ie,ag as Sa,b8 as Ca,c as ee,b9 as za,X as oe,ba as $a,M as Fa,bb as mt,a9 as le,F as pt,L as ft,K as vt,bc as gt,J as xt,N as Oa,T as Na,O as Ia,P as La,Q as Va,R as Pa,U as Ea,V as Ra,W as Aa,Y as Da,x as m,A as ja,bd as ye,be as Me,a1 as Ga,aq as Ba,B as Ha,aS as Wa,a3 as ka,az as Ua}from"./OutputColorHighlightOID.glsl-DwdqLrg1.js";import{t as ze,Q as Le}from"./InterleavedLayout-DtbZ-5ze.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-DA1GEvam.js";import{r as Ya}from"./VertexBuffer-CltW2dL7.js";import{g as Za}from"./plane-Lq4YhOGl.js";import{T as Ve,d as Pe,_ as qa}from"./renderState-CKc66y4x.js";import{t as Xa}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as ge}from"./ShaderBuilder-AS_x1hwJ.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
gl_FragDepth = _linearDepth;
  ...
  `)}function Ct(a,e){const{vertex:t,fragment:r,varyings:o}=a,{hasColorTexture:s,alphaDiscardMode:d}=e,n=s&&d!==1,{output:l,normalType:u,hasColorTextureTransform:f}=e;switch(l){case 2:A(t,e),a.include(D),r.include(G,e),a.include(j,e),n&&r.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),a.include(B,e),r.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(D),a.include(j,e),a.include(K,e),a.include(po,e),r.include(G,e),a.include(xa,e),ba(a),o.add("depth","float",{invariant:!0}),n&&r.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),a.include(B,e),r.main.add(i`
        ...
        ${l===10?i`outputObjectAndLayerIdColor();`:i`outputDepth(depth);`}`);break;case 3:{A(t,e),a.include(D),a.include(xe,e),a.include(wt,e),a.include(j,e),a.include(K,e),n&&r.uniforms.add(new y("tex",M=>M.texture)),u===2&&o.add("vPositionView","vec3",{invariant:!0});const v=u===0||u===1;t.main.add(i`
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case 9:A(t,e),a.include(D),a.include(j,e),a.include(K,e),n&&r.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
}`)}function jo(a,e){e.hasColorTextureTransform?(a.varyings.add("colorUV","vec2"),a.vertex.uniforms.add(new I("colorTextureTransformMatrix",t=>t.colorTextureTransformMatrix??U)).code.add(i`void forwardColorUV(){
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
}`))}function Rt(a){const e=new ge,{attributes:t,vertex:r,fragment:o,varyings:s}=e,{output:d,normalType:n,offsetBackfaces:l,spherical:u,snowCover:f,pbrMode:v,textureAlphaPremultiplied:M,instancedDoublePrecision:C,hasVertexColors:g,hasVertexTangents:F,hasColorTexture:O,hasNormalTexture:Y,hasNormalTextureTransform:E,hasColorTextureTransform:R}=a;if(A(r,a),t.add("position","vec3"),s.add("vpos","vec3",{invariant:!0}),e.include(K,a),e.include(_t,a),e.include(mt,a),e.include(jo,a),!oe(d))return e.include(Ct,a),e;e.include(Go,a),e.include(Bo,a),e.include(Ho,a),e.include(Wo,a),le(r,a),e.include(xe,a),e.include(D);const L=n===0||n===1;return L&&l&&e.include(Mt),e.include(vo,a),e.include(wt,a),e.include(Tt,a),s.add("vPositionLocal","vec3"),e.include(j,a),e.include(St,a),e.include(pt,a),r.uniforms.add(new ft("externalColor",b=>b.externalColor,{supportsNaN:!0})),s.add("vcolorExt","vec4"),e.include(vt,a),r.include(fe),r.include(gt),e.include(C?It:Lt,a),r.main.add(i`
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ft,a),o.include(Ee,a),e.include(B,a),o.include(G,a),e.include(xt,a),le(o,a),ue(o),Ae(o),De(o),o.uniforms.add(r.uniforms.get("localOrigin"),r.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&o.uniforms.add(new y("tex",g=>g.texture)),e.include(Ot,a),o.include(Re,a),o.include(Pt),o.include(Et,a),te(o),o.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
